...
KERNEL_BOOTIMAGE_CMDLINE = console=tty0 earlycon=msm_geni_serial,0xa90000 androidboot.hardware=surfaceduo androidboot.hardware.platform=qcom androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=2048 loop.max_part=7 androidboot.usbcontroller=a600000.dwc3 kpti=off buildvariant=userdebug droidian.lvm.prefer
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/surface/surface-duo-dv-b.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = /arch/arm64/boot/dts/surface/surface-duo-dv-b-overlay.dtbo
